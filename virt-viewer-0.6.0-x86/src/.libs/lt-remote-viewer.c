...
const char * LIB_PATH_VALUE   = "/usr/i686-w64-mingw32/sys-root/mingw/lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/i686-w64-mingw32/sys-root/mingw/lib;/usr/i686-w64-mingw32/sys-root/mingw/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /usr/i686-w64-mingw32/sys-root/mingw/lib/libspice-client-gt", f);
  fputs ("k-2.0.la /usr/i686-w64-mingw32/sys-root/mingw/lib/libspice-client-glib-2.0.la /", f);
  fputs ("usr/i686-w64-mingw32/sys-root/mingw/lib/libspice-controller.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("t/mingw/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/usr/i686-w64-mingw32/sys-root/mingw/lib:$PATH\"\n", f);
  fputs ("\n", f);
