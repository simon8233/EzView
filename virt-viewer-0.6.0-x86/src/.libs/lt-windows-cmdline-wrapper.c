...
/* ./.libs/lt-windows-cmdline-wrapper.c - temporary wrapper executable for .libs/windows-cmdline-wrapper.exe
   Generated by libtool (GNU libtool) 2.4.2

   The windows-cmdline-wrapper program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "windows-cmdline-wrapper.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# windows-cmdline-wrapper - temporary wrapper script for .libs/windows-cmdline-", f);
  fputs ("wrapper.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The windows-cmdline-wrapper program cannot be directly executed until all the", f);
  fputs (" libtool\n", f);
  ...
  fputs ("    echo \"windows-cmdline-wrapper.exe:windows-cmdline-wrapper:${LINENO}: libtoo", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"windows-cmdline-wrapper.exe:windows-cmdline-wrapper:${LINENO}: newar", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"windows-cmdline-wrapper.exe:windows-cmdline-wrapper:${LINENO}: n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='windows-cmdline-wrapper.exe'\n", f);
