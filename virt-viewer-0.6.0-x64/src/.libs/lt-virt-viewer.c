...
/* ./.libs/lt-virt-viewer.c - temporary wrapper executable for .libs/virt-viewer.exe
   Generated by libtool (GNU libtool) 2.4.2

   The virt-viewer program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "virt-viewer.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# virt-viewer - temporary wrapper script for .libs/virt-viewer.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The virt-viewer program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"virt-viewer.exe:virt-viewer:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"virt-viewer.exe:virt-viewer:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"virt-viewer.exe:virt-viewer:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
