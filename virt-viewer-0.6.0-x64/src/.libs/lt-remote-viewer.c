...
/* ./.libs/lt-remote-viewer.c - temporary wrapper executable for .libs/remote-viewer.exe
   Generated by libtool (GNU libtool) 2.4.2

   The remote-viewer program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/usr/x86_64-w64-mingw32/sys-root/mingw/lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/x86_64-w64-mingw32/sys-root/mingw/lib;/usr/x86_64-w64-mingw32/sys-root/mingw/bin;";
const char * TARGET_PROGRAM_NAME = "remote-viewer.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# remote-viewer - temporary wrapper script for .libs/remote-viewer.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The remote-viewer program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /usr/x86_64-w64-mingw32/sys-root/mingw/lib/libspice-client-", f);
  fputs ("gtk-2.0.la /usr/x86_64-w64-mingw32/sys-root/mingw/lib/libspice-client-glib-2.0.", f);
  fputs ("la /usr/x86_64-w64-mingw32/sys-root/mingw/lib/libspice-controller.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"remote-viewer.exe:remote-viewer:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"remote-viewer.exe:remote-viewer:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"remote-viewer.exe:remote-viewer:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='remote-viewer.exe'\n", f);
  ...
  fputs ("-root/mingw/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/usr/x86_64-w64-mingw32/sys-root/mingw/lib:$PATH\"\n", f);
  fputs ("\n", f);
