...
const char * LIB_PATH_VALUE   = "/root/EzView/spice-gtk-0.22/gtk/controller/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/x86_64-w64-mingw32/sys-root/mingw/lib;/usr/x86_64-w64-mingw32/sys-root/mingw/bin;/root/EzView/spice-gtk-0.22/gtk/controller/.libs;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("-root/mingw/bin:/root/EzView/spice-gtk-0.22/gtk/controller/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/root/EzView/spice-gtk-0.22/gtk/controller/.libs:$PATH\"\n", f);
  fputs ("\n", f);
