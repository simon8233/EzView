...
/* ./.libs/lt-spicy-screenshot.c - temporary wrapper executable for .libs/spicy-screenshot.exe
   Generated by libtool (GNU libtool) 2.4.2

   The spicy-screenshot program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/root/EzView/spice-gtk-0.22-x86/gtk/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/i686-w64-mingw32/sys-root/mingw/lib;/usr/i686-w64-mingw32/sys-root/mingw/bin;/root/EzView/spice-gtk-0.22-x86/gtk/.libs;";
const char * TARGET_PROGRAM_NAME = "spicy-screenshot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spicy-screenshot - temporary wrapper script for .libs/spicy-screenshot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The spicy-screenshot program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("  notinst_deplibs=' libspice-client-glib-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"spicy-screenshot.exe:spicy-screenshot:${LINENO}: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spicy-screenshot.exe:spicy-screenshot:${LINENO}: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spicy-screenshot.exe:spicy-screenshot:${LINENO}: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='spicy-screenshot.exe'\n", f);
  ...
  fputs ("t/mingw/bin:/root/EzView/spice-gtk-0.22-x86/gtk/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/root/EzView/spice-gtk-0.22-x86/gtk/.libs:$PATH\"\n", f);
  fputs ("\n", f);
