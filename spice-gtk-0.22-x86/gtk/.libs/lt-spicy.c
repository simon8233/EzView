...
/* ./.libs/lt-spicy.c - temporary wrapper executable for .libs/spicy.exe
   Generated by libtool (GNU libtool) 2.4.2

   The spicy program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "spicy.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spicy - temporary wrapper script for .libs/spicy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The spicy program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libspice-client-gtk-2.0.la /root/EzView/spice-gtk-0.22-x86/", f);
  fputs ("gtk/libspice-client-glib-2.0.la libspice-client-glib-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"spicy.exe:spicy:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spicy.exe:spicy:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spicy.exe:spicy:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
