...
/* ./.libs/lt-spicy-stats.c - temporary wrapper executable for .libs/spicy-stats.exe
   Generated by libtool (GNU libtool) 2.4.2

   The spicy-stats program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "spicy-stats.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spicy-stats - temporary wrapper script for .libs/spicy-stats.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The spicy-stats program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"spicy-stats.exe:spicy-stats:${LINENO}: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spicy-stats.exe:spicy-stats:${LINENO}: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spicy-stats.exe:spicy-stats:${LINENO}: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
