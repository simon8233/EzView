...
/* ./.libs/lt-spice-controller-dump.c - temporary wrapper executable for .libs/spice-controller-dump.exe
   Generated by libtool (GNU libtool) 2.4.2

   The spice-controller-dump program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/root/EzView/spice-gtk-0.22-x86/gtk/controller/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/i686-w64-mingw32/sys-root/mingw/lib;/usr/i686-w64-mingw32/sys-root/mingw/bin;/root/EzView/spice-gtk-0.22-x86/gtk/controller/.libs;";
const char * TARGET_PROGRAM_NAME = "spice-controller-dump.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spice-controller-dump - temporary wrapper script for .libs/spice-controller-d", f);
  fputs ("ump.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The spice-controller-dump program cannot be directly executed until all the l", f);
  fputs ("ibtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libspice-controller.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"spice-controller-dump.exe:spice-controller-dump:${LINENO}: libtool wr", f);
  fputs ("apper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spice-controller-dump.exe:spice-controller-dump:${LINENO}: newargv[$", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spice-controller-dump.exe:spice-controller-dump:${LINENO}: newar", f);
  ...
  fputs ("\n", f);
  fputs ("  program='spice-controller-dump.exe'\n", f);
  ...
  fputs ("    PATH=/usr/i686-w64-mingw32/sys-root/mingw/lib:/usr/i686-w64-mingw32/sys-roo", f);
  fputs ("t/mingw/bin:/root/EzView/spice-gtk-0.22-x86/gtk/controller/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/root/EzView/spice-gtk-0.22-x86/gtk/controller/.libs:$PATH\"\n", f);
  fputs ("\n", f);
