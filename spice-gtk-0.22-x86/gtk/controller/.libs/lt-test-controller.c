...
/* ./.libs/lt-test-controller.c - temporary wrapper executable for .libs/test-controller.exe
   Generated by libtool (GNU libtool) 2.4.2

   The test-controller program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test-controller.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test-controller - temporary wrapper script for .libs/test-controller.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The test-controller program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test-controller.exe:test-controller:${LINENO}: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-controller.exe:test-controller:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-controller.exe:test-controller:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test-controller.exe'\n", f);
